  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center text-white px-4 text-center space-y-6">
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <button
          onClick={() => navigate("/laporan-ditemukan")}
          className="px-8 py-3 text-lg font-semibold bg-teal-500 rounded-lg shadow-lg hover:bg-teal-600 transform hover:scale-105 transition duration-300 text-white"
        >
          Laporan Ditemukan
        </button>
      </div>
